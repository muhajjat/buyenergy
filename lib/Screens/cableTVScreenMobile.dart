...
class CableTVScreenMobile extends StatefulWidget {
  @override
  CableTVScreenMobileState createState() => CableTVScreenMobileState();
}

class CableTVScreenMobileState extends State<CableTVScreenMobile> {
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Cable TV", style: MyTextStyles().title),
                        const SizedBox(height: 10),
                        MyDivider(),
                        const SizedBox(height: 10),
                      ],
                  ...
                  Container(
                      ...
                      child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                              ...
                              items: cableTV.map((String valueItem) {
                        ...
                        if (selectedBiller == "Select Biller") {
                          ...
                          if (selectedBiller != "") {
                            if (selectedBiller == "Startimes") {
                              ...
                              fetchMultichoiceplans(
                                  biller: selectedBiller.toLowerCase(),
                                  account: smartCardNumberTC.text);
                            }
                          }
                        }  else {
