...
class DataPurchaseScreenDesktop extends StatefulWidget {
  @override
  DataPurchaseScreenDesktopState createState() =>
      DataPurchaseScreenDesktopState();
}

class DataPurchaseScreenDesktopState extends State<DataPurchaseScreenDesktop> {
                ...
                Padding(
                    ...
                    child: Card(
                      ...
                      child: Container(
                        width: 300,
                        child:
                            DesktopDrawer.drawerDetails(context, "Data Bundle"),
                      ),
                    )),
                                          ...
                                          onChanged: (val) {
                                            ...
                                            setState(() {
                                              ...
                                              showDialog(
                                                ...
                                                context: context,
                                                builder: (context) => MyLoader("Fetching $selectedNetwork Data Plans"),
                                              );
