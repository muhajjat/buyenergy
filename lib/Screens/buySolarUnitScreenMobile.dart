...
class BuySolarUnitsScreenMobile extends StatefulWidget {
  @override
  BuySolarUnitsScreenMobileState createState() =>
      BuySolarUnitsScreenMobileState();
}

class BuySolarUnitsScreenMobileState extends State<BuySolarUnitsScreenMobile> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 10),
                        Text("Buy Solar unit", style: MyTextStyles().title),
                        SizedBox(height: 10),
                        MyDivider(),
                        SizedBox(height: 10),
                      ],
                  ...
                  Container(
                      ...
                      child: DropdownButtonHideUnderline(
                          ...
                          items: solarBillers.map((String valueItem) {
