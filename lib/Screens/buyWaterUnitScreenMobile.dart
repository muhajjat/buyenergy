...
class BuyWaterUnitsScreenMobile extends StatefulWidget {
  @override
  BuyWaterUnitScreenMobileState createState() =>
      BuyWaterUnitScreenMobileState();
}

class BuyWaterUnitScreenMobileState
    extends State<BuyWaterUnitsScreenMobile> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 10),
                        Text("Buy Water unit", style: MyTextStyles().title),
                        SizedBox(height: 10),
                        MyDivider(),
                        SizedBox(height: 10),
                      ],
