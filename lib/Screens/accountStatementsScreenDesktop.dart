...
class AccountStatementsScreenDesktop extends StatefulWidget {
  @override
  AccountStatementsScreenDesktopState createState() =>
      AccountStatementsScreenDesktopState();
}

class AccountStatementsScreenDesktopState
    extends State<AccountStatementsScreenDesktop> {
  ...
  Widget accountStatementsUI(String transactionType, email, fullName, date,
      time, meterNumber, amount, type, reference, billerName) {
    return Container(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text("$date at $time"),
                  Constants.topMargin(6),
                  Text("Token: 345676543234/Ref: $reference"),
