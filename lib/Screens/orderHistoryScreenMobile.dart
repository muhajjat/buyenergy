...
class OrderHistoryScreenMobile extends StatefulWidget {
  @override
  OrderHistoryScreenMobileState createState() => OrderHistoryScreenMobileState();
}

class OrderHistoryScreenMobileState extends State<OrderHistoryScreenMobile> {
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Order History", style: MyTextStyles().title),
                        const SizedBox(height: 10),
                        MyDivider(),
                        const SizedBox(height: 10),
                      ],
