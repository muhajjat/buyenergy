...
class TransactionScreenMobile extends StatefulWidget {
  @override
  TransactionScreenMobileState createState() => TransactionScreenMobileState();
}

class TransactionScreenMobileState extends State<TransactionScreenMobile> {
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Transactions", style: MyTextStyles().title),
                        const SizedBox(height: 10),
                        MyDivider(),
                        const SizedBox(height: 10),
                      ],
