...
class BuyEnergyUnitsScreenMobile extends StatefulWidget {
  @override
  BuyEnergyUnitsScreenMobileState createState() =>
      BuyEnergyUnitsScreenMobileState();
}

class BuyEnergyUnitsScreenMobileState
    extends State<BuyEnergyUnitsScreenMobile> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 10),
                        Text("Buy Energy unit", style: MyTextStyles().title),
                        SizedBox(height: 10),
                        MyDivider(),
                        SizedBox(height: 10),
                      ],
                  ...
                  Container(
                      ...
                      child:DropdownButtonHideUnderline(
                          ...
                          items: billers.map((String valueItem) {
                          ...
                          onChanged: (val) {
                            ...
                            setBillerName(selectedBiller, selectedMeterType);
                          }))),
                      ...
                      Expanded(
                        child: Container(
                            ...
                            child: DropdownButtonHideUnderline(
                                ...
                                items: meterTypes.map((String valueItem) {
                                  return DropdownMenuItem<String>(
                                    value: valueItem,
                                    child: Text(
                                      valueItem,
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        if (selectedBiller == "Select Biller") {
                          Constants.showToast(
                              msg: "Select your biller", timeInSecForIosWeb: 3);
                        } else if (selectedMeterType == "Select Meter Type") {
                          Constants.showToast(
                          ...
                          Constants.showToast(
                              ...
                              timeInSecForIosWeb: 3);
                        } else if(int.parse(amountTC.text) < 1000){
                          Constants.showToast(
                               msg: "Amount cannot be less than N1,000",
                              // msg: "Amount MUST BE N100",
                              timeInSecForIosWeb: 3);
  ...
  void setBillerName(String selectedBiller, String selectedMeterType) {
    if (selectedBiller != "Select Biller" &&
      ...
      } else if (selectedBiller == "Abuja Electricity Distribution Company (AEDC)" &&
    ...
    /// Kaduna Electricity
    if (selectedBiller == "Kaduna-Electricity (KAEDCO)" && selectedMeterType == "Prepaid") {
      setState(() {
        billerName = "kedco";
      });
    } else if (selectedBiller == "Benin Disco" &&
  ...
  /// Set biller name for Flutterwave
  // void setBillerName(String selectedBiller, String selectedMeterType) {
  //   if (selectedBiller != "Select Biller" &&
  //       selectedMeterType != "Select Meter Type") {
  //     /// AEDC
  ...
  //         selectedMeterType == "Prepaid") {
  //       setState(() {
  //         billerName = "aedcPrepaid";
  //       });
  //     } else if (selectedBiller == "Abuja Electricity Distribution Company (AEDC)" &&
  //         selectedMeterType == "Postpaid") {
  //       setState(() {
  //         billerName = "aedcPostpaid";
  //       });
  //     }
  //
  //     /// EKEDC
