...
import 'package:buy_energy/Screens/digitalInvoiceDetails.dart';
...
class DigitalInvoiceScreenMobile extends StatefulWidget {
  @override
  DigitalInvoiceScreenMobileState createState() =>
      DigitalInvoiceScreenMobileState();
}

class DigitalInvoiceScreenMobileState
    extends State<DigitalInvoiceScreenMobile> {
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Digital Invoice", style: MyTextStyles().title),
                        const SizedBox(height: 10),
                        MyDivider(),
                        const SizedBox(height: 10),
                      ],
  ...
  Widget digitalInvoiceUI(String transactionType, email, fullName, date, time,
        ...
        children: [
          ...
          Align(
            ...
            child: ElevatedButton(
              onPressed: () async {
                final pdfFile = await DigitalInvoiceDetails.generate(
                    billerName, transactionType, amount, date, time);
              ...
              child: Text("Generate/Print Invoice"),
            ),
          ),
          const Divider(
            thickness: 2,
